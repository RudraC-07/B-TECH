  ...
  return (
   ...
   <div className="h-full px-3 py-4 overflow-y-auto bg-neutral-primary-soft border-e border-default">
      <ul className="space-y-2 font-medium">
        ...
        <div id="body" className="mt-35 ml-100">{children}</div>

        <div id="footer" className="mt-60"><footer className="bg-neutral-primary-soft rounded-base shadow-xs border border-default m-4">
